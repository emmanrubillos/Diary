        ...
        <form action="{{route('diary.update', $diary->id )}}" method="POST">
            ...
            <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="eod" name="end_day" rows="3">{{ $diary->end_day }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="roadblocks">Roadblocks</label>
                        <textarea class="form-control" id="roadblocks" name="roadblock" rows="3">{{ $diary->roadblock }}</textarea>
                    </div>
                    <div class="form-group">
