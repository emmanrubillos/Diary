        ...
        <form action="{{route('diary.store')}}" method="POST">
            ...
            <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="todays-plan" name="plan_today" rows="3">{{ old('plantoday') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="eod">End of Day Report</label>
                        <textarea class="form-control" id="eod" name="end_day" rows="3">{{ old('eod') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="roadblocks">Roadblocks</label>
                        <textarea class="form-control" id="roadblocks" name="roadblock" rows="3">{{ old('roadblocks') }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="tomorrows-plan" name="plan_tomorrow" rows="3">{{ old('plantomorrow') }}</textarea>
                    </div>
                    <div class="form-group">
