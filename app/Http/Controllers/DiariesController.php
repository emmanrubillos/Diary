...
class DiariesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.diary.create')->with('supervisors',$supervisors);
    }
    ...
    public function store(Request $request)
    {
            ...
            return view('admin.diary.index')->with('diaries',$diaries);
    ...
    public function show($id)
    {
        ...
        return view('admin.diary.show')->with('diary',$diary_details);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.diary.edit')->with([
            'diary' => $diary,
    ...
    public function generateDatatables($request)
    {
        return DataTables::of($request)
                ...
                ->addColumn('action', function($data){
                    $actionButtons = '<a href="'.route("diary.show",$data->id).'" data-id="'.$data->id.'" class="btn btn-sm btn-primary">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="'.route("diary.edit",$data->id).'" data-id="'.$data->id.'" class="btn btn-sm btn-warning editDiary">
